...
(function () {
    ...
    function load() {
        ...
        inputScript("https://iclient.supermap.io/examples/js/tokengenerator.js");
        ...
        if (!inArray(excludes, 'example-i18n')) {
            ...
            inputScript("https://iclient.supermap.io/examples/js/utils.js");
            inputScript("https://iclient.supermap.io/examples/js/localization.js");
            document.writeln("<script>Localization.initializeI18N('https://iclient.supermap.io/examples/', function () {Localization.localize();Localization.initGlobal();}); </script>");
            jQueryInclude = true;
        }
        ...
        if (inArray(includes, 'widgets.alert')) {
            inputScript("https://iclient.supermap.io/examples/js/widgets.js");
        }
